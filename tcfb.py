...
a = " \033[1;97m[\033[1;31m0_0\033[1;97m] => "
def logo():
...
║░░░░░░░░╚══╝░░░╚══╝░░╚═╝░░░░░╚═╝╚═╝░░░╚═╝░░░░░░║
╠═══════════════════════════════════════════════╣
║▶ FaceBook : facebook.com/DuongThai            ║
║▶ Zalo : 0943040079                            ║
║▶ Bạn Không Ngu, Do Tôi Quá Giỏi               ║
╚═══════════════════════════════════════════════╝
╔═══════════════════════════════════════════════════════╗\033[1;32m
║───────────────────────────────────────────────────────║
{a}{yellow}Tool Tố Cáo Facebook
{a}{red}Copyright: -))
{a}{blue}Zalo: 0943040079
...
print("\033[1;31m─────────────────────────────────────────────────────────")
cookie_fb=input(' \033[1;97m[\033[1;31m+_+\033[1;97m] =>\033[1;32m Nhập COOKIE Facebook:\033[1;97m ')
id_fb=input(' \033[1;97m[\033[1;31m+_+\033[1;97m] =>\033[1;32m Nhập ID Cần Tố Cáo:\033[1;97m ')
print('WAITING..',end='\r')
...
for i in range(randint(555,999)):
    s=i+1
    print(f'{s} - Tố Cáo Thành Công ID: {id_fb}')
    time.sleep(0.01)
print(" \033[1;97m[\033[1;31m+_+\033[1;97m] => Done!")
